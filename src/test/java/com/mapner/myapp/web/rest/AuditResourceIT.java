...
import com.mapner.myapp.config.audit.AuditEventConverter;
import com.mapner.myapp.domain.PersistentAuditEvent;
import com.mapner.myapp.repository.PersistenceAuditEventRepository;
import com.mapner.myapp.security.AuthoritiesConstants;

import com.mapner.myapp.service.AuditEventService;
